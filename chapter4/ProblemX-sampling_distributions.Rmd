...
1.  Describe this population distribution.
  > The population distribution is right-skewed and uni-modal.
...
2.  Describe the distribution of this sample. How does it compare to the 
  ...
  > The distribution is the sample is uni-modal, and slightly right-skewed, however more normal than the population distribution.
...
mean(samp2)
```
  > The mean of samp2 is smaller than the mean of samp1
  > The sample of size 1000 would provide a more accurate estimate of the population
...
4.  How many elements are there in `sample_means50`?  Describe the sampling 
  ...
  > The distribution is normally distributed and approximately symettrical
  > The center of the distribution is around 1500
  > The distribution should become more normal with 50,000 sample means
...
sample_means_small
```
  > There are 100 elements in sample_means_small with each element representing a different mean for every sample
...
6.  When the sample size is larger, what happens to the center?  What about the spread?
  > When the sample size is larger, the center becomes more aligned with the true population mean. The spread also becomes less variable with larger samples.
...
mean(price)
```
  > The shape of the sampling distribution is approximately symmetrical, uni-modal, and normally distributed 
  > From the distribution, I would estimate the population mean to be around 180,000
...
mean(price)
```
  > The shape of the sampling distribution is approximately symmetrical, uni-modal, and normally distributed. It is more normal to the distribution of sample_means50
  > From the distribution, I would estimate the population mean to be around 180,000
...
-   Of the sampling distributions from 2 and 3, which has a smaller spread?  If
  ...
  > The spread is smaller in question 3 (sample_means150)
  > We would prefer a distribution with a small spread because the bulk of the distribution is centered more around the mean
